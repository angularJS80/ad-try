package com.example.jcompia.tutoralnavi3.adapter;
...
public class MyHashMapAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        Log.d("MyHashMapAdapter ",mListItems.get(position).toString());
        String stringItem = (String )mListItems.get(position).get("value");
        if (stringItem != null) {
